...
public class SampleController {
	...
	public ModelAndView findAllTask(ModelMap map) {
	...
	public User saveUser(MultipartFile photo, MultipartFile resumePdf, @RequestParam String name,
			@RequestParam String email, @RequestParam long phoneNumber, @RequestParam String username,
	...
	@RequestMapping("/view_all_data")
	public ModelAndView viewData(ModelMap map) {
		...
		ModelAndView mav = new ModelAndView("ViewData");
		return mav;
